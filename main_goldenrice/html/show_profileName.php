<?php
		...
		if(isset($_COOKIE["adminUser"]))
		{
			...
			echo "<li><a href='Admin_profile_page.php'>". $p_name ."</a></li>";
			echo "<li><a href='logout_core.php'> LOGOUT </a></li>";
		}
		else if(isset($_COOKIE["platiUser"]))
		{
			...
			echo "<li><a href='platinum_profile.php'>". $p_name ."</a></li>";
			echo "<li><a href='logout_core.php'> LOGOUT </a></li>";
		}
		else if(isset($_COOKIE["reguUser"]))
		{
			...
			echo "<li><a href='regular_profile.php'>". $p_name ."</a></li>";
			echo "<li><a href='logout_core.php'> LOGOUT </a></li>";
		}
		else
		{
